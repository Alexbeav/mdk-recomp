...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "MDK",
    .project_root_env = "MDK_RECOMP_PROJECT_ROOT",
    .build_dir_env = "MDK_RECOMP_BUILD_DIR",
    .force_setup_env = "MDK_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_005.99_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "MDK_Recompiled",
    .prepare_note =
